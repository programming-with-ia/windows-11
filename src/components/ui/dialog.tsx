...
export const dialogVariants = cva(
    "fixed z-50 grid w-full gap-4 ease-linear border bg-background p-6 shadow-lg duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out sm:rounded-lg data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0",
    {
        variants: {
            side: {
                top: "top-0",
...
>(({ className, side, align, from, children, ...props }, ref) => (
    <DialogPortal>
        {/* <DialogOverlay /> */}
        <DialogPrimitive.Content
            ...
            className={cn(
                ...
                dialogVariants({ side, align, from }),
                className,
            )}
            {...props}
        >
